...
class BASICToken:
        ...
        ######## YST extension
        SCREEN          = 89    # SCREEN KEYWORD
        CLS             = 90    # CLS KEYWORD (STATEMENT)
        LOCATE          = 91    # LOCATE keyword
        COLOR           = 92    # COLOR keyword
        INKEY           = 93    # INKEY$ keyword
        RENUM           = 94    # RENUM command
        BEEP            = 95    # BEEP keyword (Statement)
        ...
        functions = {ABS, ATN, COS, EXP, INT, LOG, POW, RND, SIN, SQR, TAN,
                     ...
                     ROUND, MAX, MIN, INSTR, PI, RNDINT, TAB, LEFT, RIGHT, INKEY}
